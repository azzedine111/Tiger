...
#line 51 "src/parse/parsetiger.yy"
...
#line 87 "src/parse/parsetiger.yy"
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_exps = 64,                             // exps
        S_ss_exps = 65,                          // ss_exps
        S_lvalue = 66,                           // lvalue
        S_funchunk = 67,                         // funchunk
        S_fundec = 68,                           // fundec
        S_vardec = 69,                           // vardec
        S_varchunk = 70,                         // varchunk
        S_tychunk = 71,                          // tychunk
        S_tydec = 72,                            // tydec
        S_ty = 73,                               // ty
        S_tyfields = 74,                         // tyfields
        S_75_tyfields_1 = 75,                    // tyfields.1
        S_tyfield = 76,                          // tyfield
        S_varfields = 77,                        // varfields
        S_78_varfields_1 = 78,                   // varfields.1
        S_varfield = 79                          // varfield
      };
    };
...
#line 2667 "parsetiger.tab.hh"


// "%code provides" blocks.
#line 67 "src/parse/parsetiger.yy"
