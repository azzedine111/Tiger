...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // field
      char dummy5[sizeof (ast::FieldInit*)];

      // funchunk
      char dummy6[sizeof (ast::FunctionChunk*)];

      // fundec
      char dummy7[sizeof (ast::FunctionDec*)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_varfields = 80,                        // varfields
        S_81_varfields_1 = 81,                   // varfields.1
        S_varfield = 82                          // varfield
      };
    };
